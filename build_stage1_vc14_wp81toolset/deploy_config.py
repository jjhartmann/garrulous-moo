...
config = {}
cmdline = ['C:/Marmalade/7.10/s3e/makefile_builder/mkb.py', 'd:/Marmalade/Stage1/Stage1.mkb', '--deploy-only', '--hub-data', 'D:/Marmalade/Stage1/project_Stage1/mkb-wp81.txt', '--buildenv=VC14', '--buildenv-toolset=WP81']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'wp81-arm' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_wp81toolset/Debug_Stage1_VC14_WP81TOOLSET_arm/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_wp81toolset/Release_Stage1_VC14_WP81TOOLSET_arm/Stage1.s86',
                 },
         'wp81-x86' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_wp81toolset/Debug_Stage1_VC14_WP81TOOLSET_x86/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_wp81toolset/Release_Stage1_VC14_WP81TOOLSET_x86/Stage1.s86',
                 },
        }
    arm_arch = ''
