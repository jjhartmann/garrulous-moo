...
config = {}
cmdline = ['C:/Marmalade/7.10/s3e/makefile_builder/mkb.py', 'd:/Marmalade/Stage1/Stage1.mkb', '--deploy-only', '--hub-data', 'D:/Marmalade/Stage1/project_Stage1/mkb-win10.txt', '--buildenv=VC14', '--buildenv-toolset=WIN10']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'win10-x86' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_win10toolset/Debug_Stage1_VC14_WIN10TOOLSET_x86/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_win10toolset/Release_Stage1_VC14_WIN10TOOLSET_x86/Stage1.s86',
                 },
         'win10-arm' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_win10toolset/Debug_Stage1_VC14_WIN10TOOLSET_arm/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_win10toolset/Release_Stage1_VC14_WIN10TOOLSET_arm/Stage1.s86',
                 },
        }
    arm_arch = ''
