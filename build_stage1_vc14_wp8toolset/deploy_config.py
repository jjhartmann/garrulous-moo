...
config = {}
cmdline = ['C:/Marmalade/7.10/s3e/makefile_builder/mkb.py', 'd:/Marmalade/Stage1/Stage1.mkb', '--deploy-only', '--hub-data', 'D:/Marmalade/Stage1/project_Stage1/mkb-wp8.txt', '--buildenv=VC14', '--buildenv-toolset=WP8']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'wp8-x86' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_wp8toolset/Debug_Stage1_VC14_WP8TOOLSET_x86/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_wp8toolset/Release_Stage1_VC14_WP8TOOLSET_x86/Stage1.s86',
                 },
         'wp8-arm' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_wp8toolset/Debug_Stage1_VC14_WP8TOOLSET_arm/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_wp8toolset/Release_Stage1_VC14_WP8TOOLSET_arm/Stage1.s86',
                 },
        }
    arm_arch = ''
