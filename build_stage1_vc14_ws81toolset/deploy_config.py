...
config = {}
cmdline = ['C:/Marmalade/7.10/s3e/makefile_builder/mkb.py', 'd:/Marmalade/Stage1/Stage1.mkb', '--deploy-only', '--hub-data', 'D:/Marmalade/Stage1/project_Stage1/mkb-ws81.txt', '--buildenv=VC14', '--buildenv-toolset=WS81']
...
class DefaultConfig(DeployConfig):
    ...
    target = {
         'ws81-arm' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_ws81toolset/Debug_Stage1_VC14_WS81TOOLSET_arm/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_ws81toolset/Release_Stage1_VC14_WS81TOOLSET_arm/Stage1.s86',
                 },
         'ws81-x86' : {
                   'debug'   : r'd:/Marmalade/Stage1/build_stage1_vc14_ws81toolset/Debug_Stage1_VC14_WS81TOOLSET_x86/Stage1.s86',
                   'release' : r'd:/Marmalade/Stage1/build_stage1_vc14_ws81toolset/Release_Stage1_VC14_WS81TOOLSET_x86/Stage1.s86',
                 },
        }
    arm_arch = ''
